...
async function main() {
  ...
  //   amountADesired: parseUnits("1", 10).toString(),
  //   amountBDesired: parseUnits("2750", 10).toString(),
  ...
  await addLiquidityToPair({
    ...
    amountADesired: parseUnits("1", 18).toString(),
    amountBDesired: parseUnits("400", 18).toString(),
    mintTokensA: false,
    mintTokensB: true,
  });
  ...
  //   tokenA: deployedContracts.tokens.ZTC as Address,
  //   tokenB: deployedContracts.tokens.ETH as Address,
  //   amountADesired: parseUnits("6.875", 16).toString(),
  //   amountBDesired: parseUnits("1", 16).toString(),
  //   mintTokensA: false,
